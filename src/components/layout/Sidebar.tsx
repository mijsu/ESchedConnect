      ...
      <div className="w-64 flex flex-col bg-gradient-to-b from-slate-900 to-slate-800 text-white min-h-screen">
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">UniScheduler</span>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-emerald-400/20 bg-white/5 backdrop-blur-sm">
        {!collapsed && (
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-white/10 backdrop-blur-md rounded-lg flex items-center justify-center border border-white/20 shadow-lg">
              <img src="/logo.png" alt="PTC Logo" className="w-6 h-6 object-contain" />
            </div>
            <span className="font-bold text-lg text-white/95">UniScheduler</span>
          </div>
        )}
        <Button
          variant="ghost"
