    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">UniScheduler</h1>
          ...
          <TabsContent value="signup">
            <Card className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
              <CardHeader>
                ...
                <CardDescription className="text-emerald-100">Sign up to get started with UniScheduler</CardDescription>
              </CardHeader>
              <CardContent>
